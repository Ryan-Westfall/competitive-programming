...
**Companies:** tcs, Google, Amazon, IBM, Microsoft, Bloomberg, Meta, Infosys, Verkada, UiPath, AMD, Adobe, Wix, Oracle, Docusign, Palo Alto Networks, LinkedIn, Salesforce, BlackRock, Zoho, TikTok, Walmart Labs, JPMorgan Chase, Swiggy, Booking.com, DoorDash, X
**Language:** Python3
**Runtime:** 3 ms (76.7%)
**Memory:** 19.3 MB (27.0%)
