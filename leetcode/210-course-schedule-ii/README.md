...
**Companies:** Amazon, Anduril, Apple, Netflix, Google, Salesforce, Uber, Bloomberg, Snowflake, Microsoft, Walmart Labs, Aurora, Audible, Roblox, Meta, Oracle, LinkedIn, Citadel, TikTok, Snap, Goldman Sachs, MongoDB, Intuit, DoorDash, Nvidia, Arista Networks, Palantir, Nutanix, Flipkart, Qualcomm, Remitly, Zenefits
**Language:** Python3
**Runtime:** 7 ms (26.8%)
**Memory:** 20.3 MB (91.2%)
