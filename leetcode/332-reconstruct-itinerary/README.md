...
**Companies:** Pinterest, Google, Apple, Bloomberg, Amazon, Citadel, Salesforce, Compass, Yandex, Uber, Meta, eBay, Microsoft, Booking.com, Flipkart, Palo Alto Networks, PhonePe
**Language:** Python3
**Runtime:** 3 ms (75.4%)
**Memory:** 20.1 MB (29.4%)
