...
## Hints
1. <p>Fix the left endpoint and extend the right endpoint while maintaining the numbers of even and odd elements.</p>
2. <p>A subarray with <code>y &gt; 0</code> is valid exactly when <code>b * x &lt;= a * y</code>. Use this comparison instead of floating-point division.</p>
## Solution
