...
## Hints
1. <p>Try every pair of distinct indices and compute its strength directly.</p>
2. <p>Use 64-bit integers when multiplying the two values.</p>
## Solution
