...
## Hints
1. <p>Keep track of the elevator's current floor, starting from floor 0.</p>
2. <p>For each requested floor, add the absolute difference between it and the current floor to the answer, then update the current floor.</p>
## Solution
