...
**Companies:** Amazon, Google, Meta, Bloomberg, Microsoft, tcs, Apple, Nykaa, ZScaler, Oracle, eBay, Goldman Sachs, Walmart Labs, Infosys, Nutanix, ServiceNow, Nvidia, Autodesk, JPMorgan Chase
**Language:** Python3
**Runtime:** 243 ms (10.4%)
**Memory:** 16.4 MB (100.0%)
