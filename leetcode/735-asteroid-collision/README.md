...
**Companies:** Amazon, Google, Bloomberg, DE Shaw, Infosys, Nutanix, Oracle, Meta, Microsoft, DoorDash, PayPal, TikTok, ServiceNow, Qualtrics, Dream11, Flipkart, Nvidia, Goldman Sachs, Accolite, Salesforce, PhonePe, OpenAI, Deloitte, Uber
**Language:** Python3
**Runtime:** 7 ms (57.2%)
**Memory:** 18.6 MB (100.0%)
