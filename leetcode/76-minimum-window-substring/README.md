...
**Companies:** Amazon, Microsoft, Lyft, Meta, Google, Goldman Sachs, LinkedIn, Bloomberg, Oracle, Adobe, TikTok, Salesforce, Infosys, IBM, Snowflake, Uber, SoFi, Zeta Global, Yandex, Airbnb, Snap, Swiggy, DP world, thoughtspot, Meesho
**Language:** Python3
**Runtime:** 64 ms (66.0%)
